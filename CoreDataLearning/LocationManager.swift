...
//
//  Created by Rahul Dhiman on 8/29/18.
...
//        self.log(msg: "lat:\(latestLocation.latitude), long:\(latestLocation.longitude)" ,title: "Location testing - [FTS :)]")
...
//        if isDEBUG {
//            AppDelegate.sharedDelegate().fireLocalNotification(msg: msg, title: title)
//        }
    }
}
